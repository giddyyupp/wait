...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--centerCropSize', type=int, default=256, help='first center crop to this size')
        ...
        parser.add_argument('--norm_warp', type=str, default='batch', help='instance normalization or batch normalization for warp models')
        ...
        parser.add_argument('--merge_method', default='concat', help='merge method for deform layers sum | concat')
        ...
        parser.add_argument('--resize_or_crop', type=str, default='resize_and_centercrop', help='scaling and cropping of images at load time [resize_and_crop|crop|scale_width|scale_width_and_crop|none]')
