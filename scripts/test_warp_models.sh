...
# peters
python test.py --dataroot ${dataset_dir} --name ${exp_id} --model cycle_gan_warp --netG ${gen_type} --centerCropSize 800 --resize_or_crop center_crop --no_flip --phase test --epoch 300 --time_gap 0 ${flag_norm} ${param_norm} ${bug_fix} ${speed_up} --final_conv --merge_method "sum"
python test.py --dataroot ${dataset_dir} --name ${exp_id} --model cycle_gan_warp --netG ${gen_type} --centerCropSize 800 --resize_or_crop center_crop --no_flip --phase test --epoch 290 --time_gap 0 ${flag_norm} ${param_norm} ${bug_fix} ${speed_up} --final_conv --merge_method "sum"
python test.py --dataroot ${dataset_dir} --name ${exp_id} --model cycle_gan_warp --netG ${gen_type} --centerCropSize 800 --resize_or_crop center_crop --no_flip --phase test --epoch 270 --time_gap 0 ${flag_norm} ${param_norm} ${bug_fix} ${speed_up} --final_conv --merge_method "sum"
python test.py --dataroot ${dataset_dir} --name ${exp_id} --model cycle_gan_warp --netG ${gen_type} --centerCropSize 800 --resize_or_crop center_crop --no_flip --phase test --epoch 250 --time_gap 0 ${flag_norm} ${param_norm} ${bug_fix} ${speed_up} --final_conv --merge_method "sum"
python test.py --dataroot ${dataset_dir} --name ${exp_id} --model cycle_gan_warp --netG ${gen_type} --centerCropSize 800 --resize_or_crop center_crop --no_flip --phase test --epoch 240 --time_gap 0 ${flag_norm} ${param_norm} ${bug_fix} ${speed_up} --final_conv --merge_method "sum"
python test.py --dataroot ${dataset_dir} --name ${exp_id} --model cycle_gan_warp --netG ${gen_type} --centerCropSize 800 --resize_or_crop center_crop --no_flip --phase test --epoch 220 --time_gap 0 ${flag_norm} ${param_norm} ${bug_fix} ${speed_up} --final_conv --merge_method "sum"
python test.py --dataroot ${dataset_dir} --name ${exp_id} --model cycle_gan_warp --netG ${gen_type} --centerCropSize 800 --resize_or_crop center_crop --no_flip --phase test --epoch 200 --time_gap 0 ${flag_norm} ${param_norm} ${bug_fix} ${speed_up} --final_conv --merge_method "sum"
python test.py --dataroot ${dataset_dir} --name ${exp_id} --model cycle_gan_warp --netG ${gen_type} --centerCropSize 800 --resize_or_crop center_crop --no_flip --phase test --epoch 180 --time_gap 0 ${flag_norm} ${param_norm} ${bug_fix} ${speed_up} --final_conv --merge_method "sum"
python test.py --dataroot ${dataset_dir} --name ${exp_id} --model cycle_gan_warp --netG ${gen_type} --centerCropSize 800 --resize_or_crop center_crop --no_flip --phase test --epoch 150 --time_gap 0 ${flag_norm} ${param_norm} ${bug_fix} ${speed_up} --final_conv --merge_method "sum"
python test.py --dataroot ${dataset_dir} --name ${exp_id} --model cycle_gan_warp --netG ${gen_type} --centerCropSize 800 --resize_or_crop center_crop --no_flip --phase test --epoch 120 --time_gap 0 ${flag_norm} ${param_norm} ${bug_fix} ${speed_up} --final_conv --merge_method "sum"
