...
class CycleGANFlowModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        self.netG_A = networks.define_G(opt.input_nc, opt.output_nc, opt.ngf, f"{opt.netG}_flow", opt.norm,
        ...
        self.netG_B = networks.define_G(opt.output_nc, opt.input_nc, opt.ngf, f"{opt.netG}_flow", opt.norm,
                                        opt.norm_warp, opt.merge_method, opt.final_conv,
                                        not opt.no_dropout, opt.init_type, opt.init_gain, self.gpu_ids, depth=18,
                                        fpn_weights=opt.fpn_weights)
