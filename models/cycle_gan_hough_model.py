...
class CycleGANHoughModel(BaseModel):
    def name(self):
        return 'CycleGANHoughModel'
    ...
    def initialize(self, opt):
        ...
        visual_names_A = ['real_A_1', 'real_A_2', 'fake_B_1', 'rec_A_1']
        ...
        self.netG_A = networks.define_G(opt.input_nc, opt.output_nc, opt.ngf, f"{opt.netG}_hough", opt.norm, None,
                                        not opt.no_dropout, opt.init_type, opt.init_gain, self.gpu_ids, depth=18,
                                        fpn_weights=opt.fpn_weights)
        self.netG_B = networks.define_G(opt.output_nc, opt.input_nc, opt.ngf, f"{opt.netG}_hough", opt.norm, None,
                                        not opt.no_dropout, opt.init_type, opt.init_gain, self.gpu_ids, depth=18,
                                        fpn_weights=opt.fpn_weights)
